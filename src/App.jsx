 ...
 * Optimized for Large-Scale PDF Export
 */
...
const CustomLabel = (props) => {
  ...
  return (
    <text x={x + width / 2} y={y - 10} fill={COLORS.slate700} textAnchor="middle" fontSize={12} fontWeight="900">
      {`${value.toFixed(1)}%`}
    </text>
  );
};
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans p-6 md:p-12 lg:p-16 relative text-left">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        @media print {
          /* הסתרת כפתורים שאינם רלוונטיים ל-PDF */
          ...
          /* הפיכת כל הגרידים לעמודה אחת רחבה ב-PDF */
          .grid { 
            display: block !important; 
          }
          
          /* מניעת שבירת "קוביות" בין דפים - חשוב מאוד למראה נקי */
          div[class*="bg-white"], section, header, .mb-16 { 
          ...
          /* הגדלה משמעותית של כותרות */
          h1 { font-size: 42pt !important; margin-bottom: 15pt !important; }
          h2 { font-size: 28pt !important; margin-top: 25pt !important; border-bottom: 2pt solid #eee !important; }
          h3 { font-size: 22pt !important; }
          
          /* הגדלת מספרים מרכזיים (Key Metrics) */
          span[class*="text-4xl"], span[class*="text-6xl"] { 
          ...
          /* שיפור נראות טקסט בתוך הקוביות */
          p { font-size: 15pt !important; line-height: 1.6 !important; color: #334155 !important; }
          span[class*="text-xs"] { font-size: 12pt !important; }
          
          /* הגדלת תוויות בתוך גרפים (Recharts) */
          .recharts-text { 
            font-size: 14pt !important; 
            font-weight: bold !important; 
          }

          /* התאמת טבלאות להדפסה ברורה */
              ...
              <div className="space-y-8 text-left">
                ...
                <div className="space-y-6 pt-2 text-left">
                  ...
                  <div className="w-full h-3 bg-slate-100 rounded-full overflow-hidden flex text-left">
                    <div className="h-full bg-blue-900" style={{ width: `${genderStats.male2025}%` }}></div>
                    <div className="h-full bg-orange-500" style={{ width: `${genderStats.female2025}%` }}></div>
                  </div>
