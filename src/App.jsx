      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-10 flex flex-col md:flex-row justify-between items-start gap-4">
          <div className="text-left">
            ...
            <p className="text-lg text-slate-500 font-medium max-w-2xl">A comprehensive overview of our talent acquisition landscape.</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          <Card className="border-t-4 border-blue-900 bg-white"><Magnet size={36} className="text-blue-900 mb-6"/><h3 className="text-lg font-bold">Brand Pull: 55%</h3></Card>
          <Card className="border-t-4 border-orange-500 bg-white"><Zap size={36} className="text-orange-500 mb-6"/><h3 className="text-lg font-bold">Gen Z Pivot: 28%</h3></Card>
          <Card className="border-t-4 border-emerald-600 bg-white"><Award size={36} className="text-emerald-600 mb-6"/><h3 className="text-lg font-bold">Elite Entry: 54%</h3></Card>
          <Card className="border-t-4 border-purple-500 bg-white"><GraduationCap size={36} className="text-purple-500 mb-6"/><h3 className="text-lg font-bold">Adv. Degrees: 25%</h3></Card>
        </div>
        ...
        <section className="mb-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <Card>
              <h3 className="text-lg font-bold mb-8 flex items-center gap-2 uppercase"><Magnet size={20} className="text-blue-600"/> Sourcing</h3>
              <div className="h-[350px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={sourcingData} margin={{ top: 40 }}><CartesianGrid strokeDasharray="3 3" vertical={false} /><XAxis dataKey="name" axisLine={false} tickLine={false} /><YAxis hide /><Legend verticalAlign="top" align="right"/><Bar name="2025" dataKey="2025" fill={COLORS.navy} radius={[4, 4, 0, 0]} barSize={28}><LabelList content={<CustomLabel />} /></Bar><Bar name="2024" dataKey="2024" fill="#cbd5e1" radius={[4, 4, 0, 0]} barSize={28}><LabelList content={<CustomLabel />} /></Bar></BarChart>
                </ResponsiveContainer>
              </div>
            </Card>
            <Card>
              <h3 className="text-lg font-bold mb-8 flex items-center gap-2 uppercase"><Building2 size={20} className="text-emerald-600"/> Allocation</h3>
              <div className="h-[350px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={destinationData} margin={{ top: 40 }}><CartesianGrid strokeDasharray="3 3" vertical={false} /><XAxis dataKey="name" axisLine={false} tickLine={false} /><YAxis hide /><Legend verticalAlign="top" align="right"/><Bar name="2025" dataKey="2025" fill={COLORS.emerald} radius={[4, 4, 0, 0]} barSize={28}><LabelList content={<CustomLabel />} /></Bar><Bar name="2024" dataKey="2024" fill="#cbd5e1" radius={[4, 4, 0, 0]} barSize={28}><LabelList content={<CustomLabel />} /></Bar></BarChart>
                </ResponsiveContainer>
              </div>
            </Card>
          </div>
        ...
        <section className="mb-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <Card>
              <h3 className="text-lg font-bold mb-6 flex items-center gap-2 uppercase"><Users size={20} className="text-blue-600"/> Gender</h3>
            ...
            <Card className="lg:col-span-2">
              <h3 className="text-lg font-bold mb-6 flex items-center gap-2 uppercase"><Star size={20} className="text-orange-600"/> Age Groups</h3>
              <div className="h-[200px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={ageData} margin={{ top: 30 }}><CartesianGrid strokeDasharray="3 3" vertical={false} /><XAxis dataKey="name" axisLine={false} tickLine={false} /><YAxis hide /><Bar dataKey="value" fill={COLORS.orange} radius={[4, 4, 0, 0]} barSize={40}><LabelList content={<CustomLabel />} /></Bar></BarChart>
                </ResponsiveContainer>
              </div>
            </Card>
          </div>
        ...
        <footer className="border-t pt-8 pb-10 flex justify-between text-slate-400 text-[10px] font-black uppercase tracking-widest">
